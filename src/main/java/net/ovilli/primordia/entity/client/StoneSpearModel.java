...
public class StoneSpearModel extends EntityModel<StoneSpearEntity> {
	public static final EntityModelLayer SPEAR = new EntityModelLayer(Identifier.of(Primordia.MOD_ID, "stone_spear"), "main");
	...
	@Override
	public void setAngles(StoneSpearEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
