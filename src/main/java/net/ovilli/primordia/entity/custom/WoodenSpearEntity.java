package net.ovilli.primordia.entity.custom;
...
public class WoodenSpearEntity extends PersistentProjectileEntity {
    ...
    public WoodenSpearEntity(World world, PlayerEntity player) {
        super(PRModEntities.WOODEN_SPEAR_ENTITY, player, world, new ItemStack(PRModItems.WOODEN_SPEAR), null);
    }

    @Override
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(PRModItems.WOODEN_SPEAR);
    }
